...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.a = Point(start.x, start.y)
        self.b = Point(end.x, end.y)
        self.count = 0
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        start2 = Point(self.start.x - other_line.start.x, self.start.y - other_line.start.y)
        end2 = Point(self.end.x - other_line.end.x, self.end.y - other_line.end.y)
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        return self.__init__(self.a, self.b)
